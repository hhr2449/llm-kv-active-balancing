...
log_root="$repo_root/logs/full_o2a/conversation"
mkdir -p "$log_root" "$repo_root/checkpoints/full_o2a/conversation"
args=(
  --config "$repo_root/configs/o2_oracle/full_o2a_conversation.yaml"
