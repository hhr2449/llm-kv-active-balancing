...
config_root="$repo_root/configs/taskmain_v1.1/toolagent"
result_root="$repo_root/results/taskmain_evaluation/toolagent"
...
set +e
python "$repo_root/scripts/taskmain_v1.1/summarize_toolagent_main.py" \
